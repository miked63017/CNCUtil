...
module Pump_centrifuge_impeller_strong
 ...
 #  #  #  #  #  #  #  #  #  #  #  #  #  #
  ...
  #  #  #  #  #  #  #  #  #  #  #  #  #  #
     ...
     spoke_dist        = (mill.bit_radius * 2.5)+ spoke_width * 1.2    
     ...
     if (shaft_diam < mill.bit_diam)
       ...
       mill.plung(0.2)
       mill.pause("Final adjust 1/16 bit for 0.0 Z")
     ...
     # air_area_advance = spoke_angle * air_tilt_ratio
      ...
      aCircle = CNCShapeCircle.new(mill)
       ...
       aCircle.mill_pocket(
         pCent_x, 
         pCent_y, 
         air_entry_end_diam + mill.bit_diam * 1.5, 
         0 - (blade_height * 0.7),  
